...
Here we test if CGI sites M values are normally distributed. Our null hypothesis is that all the rows of the m_val_CGI matrix are normally distributed. Our alternative is that they are not. To perform this check we use two tests. They are the Anderson-Darling and the Shapiro-Wilks test. To control the number of false positives that may arise as a result of multiple hypothesis testing we us a bonferroni correction on the significance threshold. 
